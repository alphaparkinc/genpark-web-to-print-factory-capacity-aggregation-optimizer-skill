# genpark-web-to-print-factory-capacity-aggregation-optimizer-skill
...
> **GenPark AI Agent Skill** -- Web-to-print aggregation engine matching print jobs with idle factory capacity (RAKSUL style)
